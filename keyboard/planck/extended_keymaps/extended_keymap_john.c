...
[0] = { /* Colemak */
    ...
    {FUNC(2),           KC_A,           KC_R,           KC_S,           KC_T,           KC_D,           KC_H,               KC_N,           KC_E,               KC_I,               KC_O,           KC_ENT},
    {KC_BSPC,           KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_K,               KC_M,           KC_COMM,            KC_DOT,             KC_SLSH,        KC_DELETE},
    {LGUI(KC_Z),        KC_LCTL,        KC_LALT,        FUNC(10),       KC_LALT,        FUNC(20),       FUNC(1),            KC_LGUI,        KC_NO,              KC_NO,              KC_RALT,        KC_RCTL}
},   
...
[2] = { /* MOVEMENT AND FN*/     
    ...
    {KC_TRNS,           LALT(KC_SPC),   KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_LEFT,            KC_DOWN,        KC_UP,              KC_RGHT,            KC_NO,          KC_NO},
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [20] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_SPC),
};
